...
have I's reported too. ZZZ(add reference) For example, one
microlensing system has I measured (OGLE-2006-BLG-109L).  
...
Rossiter-McLaughlin effect or planet transiting star spots ZZZ add
references for RM effect and the star spot method. $\lambda$ is
...
<<<<<<< HEAD
{\bf SHK} is the Mount Wilson Ca II S-value and {\bf RHK} is the
Chromospheric activity of star as $\log{R'_{HK}}$ : field previously
reported the and now it is changed to SHK.  ; ZZZ What's the source
for SHK and RHK?  Still discovery paper and Butler 2006? ZZZ SHK is a
poorly maintained field, and it is unreferenced at the moment though
we plan to include proper reference in the future.
=======
>>>>>>> 74ef30cb979a09525956d6559962a20f059b0543
...
ZZZ RA, DEC, and PAR do not have references but they are from the
...
catalog. The fields J H and KS do not have references as well but they
are from the 2MASS \citep{Skrutskie2006}. The KP field do not have
reference but the values are from the Exoplanet Archive
\citep{Akeson2013}.
...
We have major updates by taking out some of the fields and by revising
the existing fields. Here, we explain why we removed or revised such
fields.  
=======
