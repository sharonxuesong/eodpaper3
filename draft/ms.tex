...
MICROLENSING, IMAGING, TIMING and ASTROMETRY: We have added MICROLENSING, IMAGING, TIMING and ASTROMETRY fields for planets discovered by methods other than radial velocity and transit. These planets are categorized as ``Other Planets"  on exoplanets.org
...
SEDEPTHJ\dotfill & Double & Secondary eclipse depth in $J$ band & -UPPER, etc. \\
SEDEPTHH\dotfill & Double & Secondary eclipse depth in $H$ band & -UPPER, etc. \\
SEDEPTHKS\dotfill & Double & Secondary eclipse depth in $K_S$
band & -UPPER, etc. \\
SEDEPTHKP\dotfill & Double & Secondary eclipse depth in the
\kepler\ photometry band & -UPPER, etc. \\
SEDEPTH36\dotfill & Double & Secondary eclipse depth in
\spitzer\ IRAC1 3.6 \micron\ band & -UPPER, etc. \\
SEDEPTH45\dotfill & Double  & Secondary eclipse depth in
\spitzer\ IRAC2 4.5 \micron\ band & -UPPER, etc. \\
SEDEPTH58\dotfill & Double  & Secondary eclipse depth in
\spitzer\ IRAC3 5.8 \micron\ band & -UPPER, etc. \\
SEDEPTH80\dotfill & Double & Secondary eclipse depth in
\spitzer\ IRAC4 8.0 \micron\ band & -UPPER, etc. \\
SET\dotfill & Double & ZZZ Epoch of secondary eclipse center in
HJD\tablenotemark{d}$-2,440,000$ & -UPPER, etc. \\
%
...
\tablenotetext{d}{ZZZ Is this now consistent? ZZZ}
\end{deluxetable}
