...
EOD: Planets discovered by radial velocity and transit method are
classified as EOD planets. They have robust orbital parameters such as
PER, ECC, K, OM, and I. \textit{(Sharon's comments: You don't need to
...
ING, IMAGING, TIMING and ASTROMETRY fields for planets discovered by
methods other than radial velocity and transit. These planets are
categorized as ``Other Planets'' on exoplanets.org. \textit{(Sharon's
