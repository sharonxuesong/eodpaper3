...
EOD. Previously, we required the planets to be smaller than 24
\mjup, but now we require the mass ratio to be smaller than 24
\mjup$/\msun$ ($< 0.023)$.
...
\item Microlensing planets:\\
  ...
  $q<0.023$). In cases of ambiguity, we consult with QUACBED.  
