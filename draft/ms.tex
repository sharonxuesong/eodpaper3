...
The first complete documentation for the EOD and the EDE was \cite{Wright2011} and since then, we have expanded the scope of the EOD and incorporated the sample of over 3000  \kepler\ Objects of Interest, (KOIs) and other planets (the ones detected by microlensing, imaging, and timing) on exoplanets.org. We also added some new fields (e.g. the secondary eclipse depths), removed obsolete fields, and revised some fields as necessary.  
